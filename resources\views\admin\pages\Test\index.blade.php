...
<main class="content">
	...
	<input type="text" class="form-control" id="asdf" name="asdf"  required>
</div>
	...
	<input type="text" class="form-control" id="edit_asdf" name="asdf"  required>
</div>
...
@section('script')
	<script>
        ...
        $(document).on('submit','#addForm',function(e){
            ...
            store_handler( "{{route('Test.store')}}" ,formData );
        });
